...
Gem::Specification.new 'flowcommerce-activemerchant' do |gem|
  ...
  gem.description = 'Adapter for Flow.io payment gateway which supports authorizations, captures, refunds and tokenization of credit cards.'
  gem.homepage    = 'https://www.flow.io'
  gem.license     = 'MIT'
  gem.authors     = ['Dino Reic']
  gem.email       = 'dino@flow.io'
