# load './lib/flowcommerce-activemerchant.rb'

Gem::Specification.new do |gem|
  gem.name        = 'flowcommerce-activemerchant'
  gem.version     = File.read('./.version').chomp # ActiveMerchant::Billing::FlowGateway::VERSION
  ...
  gem.add_runtime_dependency 'flowcommerce-reference', '~> 0.4.6'
end
